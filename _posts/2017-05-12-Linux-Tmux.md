...
你所看到的只是X个会话中的一个会话，且是该会话下面的Y个窗口中的一个窗口。是的，你在一个窗口里就可以拥有这么多个终端，这就是tmux的主要功能。。
...
## upbind-key k select-pane -U
## downbind-key j select-pane-D
## leftbind-key h select-pane -L
## rightbind-key l select-pane -R
